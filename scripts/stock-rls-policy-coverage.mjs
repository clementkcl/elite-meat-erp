...
const scopedPolicyExpectations = [
  ...
  ["stock admins can insert brands", "brands", "for insert", "can_manage_stock()"],
  ["stock admins can update brands", "brands", "for update", "can_manage_stock()"],
  ["stock admins can insert origins", "origins", "for insert", "can_manage_stock()"],
  ["stock admins can update origins", "origins", "for update", "can_manage_stock()"],
