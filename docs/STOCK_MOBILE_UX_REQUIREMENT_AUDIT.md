...
| Generated internal label saves stock immediately. | Source guarded | Immediate label save flow is covered by Stock label/inbound guards. | Generate one label, confirm stock unit/movement/scan log, then print/attach it. |
