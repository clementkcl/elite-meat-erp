...
export const demoUnits: StockUnit[] = [
  ...
  },
  {
    ...
    transferToLocationId: "loc-jalan-channel",
...
export const demoBarcodeWeightRules: BarcodeWeightRule[] = [
  {
    ...
    barcodeLength: 46,
    sampleBarcode: "910293079163102001446",
...
export const demoScanLogs: StockScanLog[] = [
  ...
  {
    id: "scan-log-004",
    barcode: "WRONG-LOC-DEMO",
    action: "TRANSFER_RECEIVED",
    success: false,
    message: "Wrong location. This barcode must be received at JALAN CHANNEL.",
    scannedBy: "demo-stock-worker",
    createdAt: "2026-06-14T09:15:00.000Z",
  },
  {
    id: "scan-log-005",
    barcode: "UNKNOWN-STOCK-TAKE",
    action: "STOCK_TAKE_ADJUSTMENT",
    success: false,
    message: "Unknown barcode exception recorded for manager/director approval.",
    scannedBy: "demo-stock-worker",
    createdAt: "2026-06-14T09:20:00.000Z",
  },
  {
    id: "scan-log-006",
    barcode: "UNAVAILABLE-DEMO",
    action: "OUTBOUND_SALES",
    success: false,
    message: "Barcode is TRANSFER_PENDING and cannot be used for this action.",
    scannedBy: "demo-stock-worker",
...
export const demoStockTakeLines: StockTakeLine[] = [
  ...
  },
  {
    ...
    itemId: "item-meat-belly-boneless",
    brandId: "brand-tican",
    barcode: "WRONG-LOC-ST-DEMO",
    itemName: "TICAN BELLY BONELESS",
    systemCount: 0,
    actualCount: 1,
    varianceCount: 1,
    systemWeightKg: 0,
    actualWeightKg: 26.78,
    varianceWeightKg: 26.78,
    exceptionType: "WRONG_LOCATION",
    exceptionStatus: "PENDING",
    exceptionLocationId: "loc-sungai-merah",
    sourceStockUnitId: "unit-003",
    resolvedStockUnitId: null,
    notes: "Demo wrong-location barcode exception waiting for approval",
