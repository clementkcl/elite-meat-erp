...
8a. If the same weight appears twice in the sample barcode, confirm the page says `Weight appears twice. Scan another sample.`
...
22. Confirm an inbound session code is auto-generated when the page opens.
