...
export const demoDeliveryJobs: DeliveryJob[] = [
  {
    id: "delivery-job-demo-1",
    jobNo: "DJ-20260623-001",
    jobType: "CUSTOMER_DELIVERY",
    status: "AVAILABLE",
    customerName: "Sungai Merah Retail",
    customerPhone: "+60 12-100 2001",
    deliveryAddress: "Sungai Merah outlet loading bay",
    deliveryNote: "Leave at receiving bay.",
    outletId: "outlet-demo",
    outletName: "Demo Outlet",
    deliveryTeamId: "department-demo",
    driverId: null,
    driverName: "-",
    vehicleId: "vehicle-lorry-01",
    vehicleNo: "EM-LORRY-01",
  ...
  {
    id: "delivery-job-demo-2",
    jobNo: "DJ-20260623-002",
    jobType: "RETURN_COLLECTION",
    status: "OUT_FOR_DELIVERY",
    customerName: "Jalan Channel Counter",
    customerPhone: "+60 12-100 2002",
    deliveryAddress: "Jalan Channel retail counter",
    deliveryNote: "Collect rejected cartons.",
    outletId: "outlet-demo",
    outletName: "Demo Outlet",
    deliveryTeamId: "department-demo",
    driverId: "driver-demo-1",
...
export const demoDeliveryExpenses: DeliveryExpense[] = [
  {
    id: "delivery-expense-demo-1",
    deliveryId: null,
    driverId: "driver-demo-1",
    driverName: "Demo Driver",
    outletId: "outlet-demo",
...
export const demoDeliveryAddressSuggestions: DeliveryAddressSuggestion[] = [
  {
    id: "delivery-address-demo-1",
    jobId: "delivery-job-demo-2",
    orderId: null,
    customerId: null,
    customerName: "Jalan Channel Counter",
    suggestedAddress: "Jalan Channel retail counter, receiving door",
    suggestedLatitude: 2.2871,
    suggestedLongitude: 111.832,
    reason: "Driver used proof GPS.",
    status: "PENDING",
    createdAt: new Date().toISOString(),
  },
]
