-- Atomic stock return RPC for barcode stock.
-- Safe to re-run in Supabase SQL Editor.

drop function if exists public.return_stock_unit(text, uuid, text, text);
...
grant execute on function public.return_stock_unit(text, uuid, text, text) to authenticated;
