...
includesAll(
  ...
  [
    ...
    "Review counts, weight, labels, and undo.",
...
includesAll(
  ...
  [
    ...
    "Mode: scan supplier barcodes",
    "Mode: print internal labels",
