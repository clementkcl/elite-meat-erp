...
- Barcode Inbound now shows a green `Scanning inbound` card above the scanner after setup is ready, with active brand, product, origin, and location plus `Session locked. Finish before changing setup.` after the first saved scan.
