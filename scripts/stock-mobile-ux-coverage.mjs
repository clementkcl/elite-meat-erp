...
includesAll(
  ...
  [
    ...
    "Setup is read-only for this session.",
    "Next: Barcode Rule",
    "Next: Manual Weight",
    ...
    "Compact list.",
    "movements and barcode scan logs.",
    ...
    "Generate an internal label, print it, then attach it.",
    ...
    "Rule fields are locked for this inbound session.",
...
includesAll(
  ...
  [
    ...
    "Valid scans save automatically.",
